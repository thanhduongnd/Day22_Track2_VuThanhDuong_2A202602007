    ...
    def validate(self, value: str, metadata: dict):
        ...
        if found_pii:
            ...
            return FailResult(
                error_message=(
                    "Phát hiện PII: "
                    + ", ".join(sorted({pii_type for pii_type, _ in found_pii}))
                ),
...
class JSONFormatter(Validator):
    ...
    # Guardrails only applies PassResult.value_override when this flag is set.
    ...
    def _repair(text: str) -> str:
        ...
        # Chỉ đổi nháy đơn dùng cho key và string value, tránh phá apostrophe
        # bên trong một chuỗi JSON vốn đã dùng nháy đôi.
